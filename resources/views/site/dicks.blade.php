...
@section('content')
    ...
    <div id="product{{$merchandise->id}}"  class="product-layout product-list col-xs-12">
        <div class="product-thumb">
            ...
            <div class="image"><a href="/admin/product/{{$merchandise->id}}"><img src="{{$merchandise->photo}}" alt="{{$merchandise->name}}" width="120px" height="120px" class="img-responsive"></a></div>
            <div>
                <div class="caption">
